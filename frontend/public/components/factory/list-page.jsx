      ...
      if (canCreate) {
        if (createProps.to) {
          ...
          createLink = <div className="co-m-primary-action">
            <Dropdown buttonClassName="btn-primary" id="item-create" noSelection={true} title={createButtonText} items={createProps.items} onChange={(name) => generateOnChange(createProps.action(name), history)} />
          </div>;
        } else {
          createLink = <div className="co-m-primary-action">
